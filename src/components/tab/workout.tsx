...
const WorkoutTab:FC<workoutProps> = ({date, month, workout, day}) => {
    ...
    <View 
      ...
      >
        <View className='flex flex-col '>
          <Text className={dateClassName+'text-2xl'}>{workout} day</Text>
          <Text className={dateClassName+'text-lg'}>{`${date} ${month}`}</Text>
        </View>
